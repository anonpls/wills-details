...
def resolve_secret_key():
    ...
    is_dev = os.getenv('FLASK_ENV') == 'development' or os.getenv('APP_ENV') == 'development'
    if is_dev:
        return 'dev-secret-key-change-me'

    raise RuntimeError('FLASK_SECRET_KEY environment variable is required outside development mode')


application.secret_key = resolve_secret_key()
